...
export type GetAlbumsQuery = { __typename?: 'Query', albums: Array<{ __typename?: 'Album', id: string, title: string, description: string, photos: Array<{ __typename?: 'Photo', id: string, title: string, blurhash?: string | null, imageUrl: string, image: { __typename?: 'DjangoImageType', width: number, height: number } }> }> };
